...
//método recursivo
	public static void mostrarJuegosAsc(int numero) {
	    if (numero == 0) {
	    	System.out.println("Ningun juego completado");
	        return;
	    }

	    // Primero baja en la recursión
	    mostrarJuegosAsc(numero - 1);

	    // Luego imprime al volver de cada llamada → ASCENDENTE
